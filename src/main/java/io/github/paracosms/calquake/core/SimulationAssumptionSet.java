...
public record SimulationAssumptionSet(
    ...
    public static final String DEFAULT_ID = "calquake-custom-v2";

    public static final SimulationAssumptionSet CALQUAKE_CUSTOM_V2 = new SimulationAssumptionSet(
            DEFAULT_ID,
            new Mechanism(0.0, 0.0, 90.0, "STRIKE_SLIP", "calquake-custom-v2 generic fallback strike-slip"),
    ...
    public static SimulationAssumptionSet resolve(String id) {
        if (DEFAULT_ID.equals(id)) {
            return CALQUAKE_CUSTOM_V2;
        }
        throw new IllegalArgumentException("Unsupported assumption set: " + id);
    }
}
